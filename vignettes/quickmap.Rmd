...
No deep R knowledge required: two lines produce a usable map, and every
extra parameter is optional.

This page is the five-minute path. It deliberately shows no options; the
rest of the manual adds them one at a time.
