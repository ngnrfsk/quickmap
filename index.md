...
chosen per layer · shortening school names · size and the plate behind
them · why reference layers get a banner key instead.
...
for a report · **where the files land** · sizing labels for the printed
page.
...
| Know where your map file gets written | [Sharing and export](articles/sharing.html) |
