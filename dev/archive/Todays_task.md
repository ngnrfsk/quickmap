...
- ask me clarifying multiple choice questions - these may include whether to extend the scope of the final report if the topics to be covered are too great for the current proposed output.
- research best practices in R data handling for spatial data mapping, including sf, openair, ggplot.
...
- Focus on key questions such as
  ...
  - Should we want to develop our own approach?
  - Is someone else doing good time varying point mapping (e.g. animating the shading a location of point) like this already?
...
- 3-5 options for HIGH LEVEL strategies to design quickmap, helper functions for it, the types of data it shoudl handle, and which data handling conventions and best practices might be best followed. 
- recommended next step

Scope:

- no coding, only research, analysis and planning
- Keep things high level for now.
- Avoid verbosity, aim for clarity, conciseness and realism
