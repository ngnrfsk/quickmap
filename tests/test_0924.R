# Test Suite for Step 4: Config Contract Update (v0.9.2.4)
# Tests get_measurement_layers() with finalized config fields (id replaces layer_type)
...
test1_old_api <- create_pollution_map(
  ...
  output_file = "test_0924_old_api_merton_no2.html",
...
test2_new_api <- create_pollution_map(
  ...
  years = 2023,
  colour_scale = "who_no2",
  output_file = "test_0924_new_api_merton_no2.html",
...
test3_partial <- create_pollution_map(
  ...
  years = 2023,
  colour_scale = "who_no2",
  output_file = "test_0924_new_api_partial.html",
...
test4_schools_only <- create_pollution_map(
  ...
  pollutant = "no2",
  colour_scale = "who_no2",
  output_file = "test_0924_old_api_schools_only.html",
...
test5_richmond <- create_pollution_map(
  ...
  output_file = "test_0924_new_api_richmond.html",
...
test6_pm25 <- create_pollution_map(
  ...
  output_file = "test_0924_old_api_pm25.html",
...
cat("  - test_0924_old_api_merton_no2.html (TEST 1)\n")
cat("  - test_0924_new_api_merton_no2.html (TEST 2 - should match TEST 1)\n")
cat("  - test_0924_new_api_partial.html (TEST 3)\n")
cat("  - test_0924_old_api_schools_only.html (TEST 4)\n")
cat("  - test_0924_new_api_richmond.html (TEST 5)\n")
cat("  - test_0924_old_api_pm25.html (TEST 6)\n")
