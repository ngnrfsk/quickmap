...
map1_richmond_no2 <- create_pollution_map(
  ...
  output_file = "debug_0926_richmond_dt_bl.html",
  title = "debug_0926 - Richmond full data (New API)",
...
map2_merton_pm25 <- create_pollution_map(
  ...
  output_file = "debug_0926_merton_pm25_2018_2024_dt_bl.html",
  title = "debug_0926 LB Merton Annual Mean PM2.5 (New API)",
...
map3_merton_no2_image <- create_pollution_map(
  ...
  output_file = "debug_0926_image_merton_no2_2018_2024_dt_bl.html",
  title = "debug_0926 LB Merton Annual Mean NO2 with Image Export (New API)",
  styling_type = "html", # HTML banner + legend
  vignette = TRUE,
  export_image = TRUE,
  marker_labels = TRUE, # Auto-hide labels
