...
map1_merton_no2 <- create_pollution_map(
  ...
  output_file = "debug_0923_richmond_dt_bl.html",
  title = "debug_0923 - Richmond full data",
...
map1_merton_pm25 <- create_pollution_map(
  ...
  output_file = "debug_0923_merton_pm25_2018_2024_dt_bl.html",
  title = "debug_0923 LB Merton Annual Mean PM2.5. ✖ Schools. Sensors: ◆ Breathe London.",
...
map1_merton_no2 <- create_pollution_map(
  ...
  output_file = "debug_0923_image_merton_no2_2018_2024_dt_bl.html",
  title = " debug_0923 LB Merton Annual Mean NO2, 2018-2024. ✖ Schools. Sensors: ● Diffusion Tubes ◆ Breathe London.",
  styling_type = "html", # HTML banner + legend
  vignette = TRUE,
  export_image = TRUE,
  marker_labels = TRUE, # Auto-hide labels
