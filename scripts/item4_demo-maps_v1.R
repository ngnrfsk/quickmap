...
#   Rscript scripts/item4_demo-maps_v1.R
...
quickmap(
  ...
  output_file = "item4_merton-annual-2020-2022_v1.html",
...
create_pollution_map(
  ...
  output_file = "item4_episode-jan2024_v1.html",
...
quickmap("merton_dt_2018_2024.csv", boroughs = "Merton",
         output_file = "item4_merton-twoline_v1.html")
